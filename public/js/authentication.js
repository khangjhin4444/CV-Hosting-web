      ...
      <div class="login-box">
          <div style="display: flex; flex-direction: column; align-items: center; gap: 8px;">
              ...
              <div style="display: flex; align-items: center; justify-content: center; column-gap: 6px;">
                  <p style="color: #878787; font-family: Roboto; font-size: 15px; font-style: normal; font-weight: 400; line-height: normal;">New to App?</p>
          ...
          <form id="login-form">
              <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 4px;">
                  ...
                  <input class="email" name="email" placeholder="Email address" style="width: 483px; padding-left: 14px; padding-top: 14px; padding-bottom: 16px; align-items: center; border-radius: 10px; border: 1px solid #B6B6B8;">
              ...
              <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 4px;">
                  ...
                  <div style="position: relative; width: 490px;">
                      <input id="password" name="password" type="password" placeholder="Enter password" style="display: flex; width: 483px; padding-left: 14px; padding-top: 14px; padding-bottom: 16px; align-items: center; gap: 10px; border-radius: 10px; border: 1px solid #B6B6B8;">
