...
<head>
  ...
  <link rel="stylesheet" href="css/cv_create.css">
...
<body>
    ...
    <div class="container-fluid pt-4 text-center" style="background-color: #F8F0E5;">
      ...
      <div class="student student-display">
        ...
        <div class="row align-items-center justify-content-center gy-2">
          <div class="col col-lg-2">
            <button class="student-btn">Yes</button>
          </div>
          <div class="col col-lg-2">
            <button class="student-btn">No</button>
          </div>
          <div class="col col-lg-2">
            <button class="student-btn">Recent Graduate</button>
          </div>
        </div>
      </div>
  ...
  <script src="./js/cv_create.js"></script>
</body>
</html>