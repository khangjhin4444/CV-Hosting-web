...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css\cv_1.css" media="all" />
  <style>
    .cv_template {
      transform: scale(0.3);
...
<body>
  <nav class="navbar navbar-expand-lg pt-0 pb-3" style="background-color: #F8F0E5;">
    <div class="container-fluid"><a href="?page=home.php" class="navbar-brand d-flex" style="margin-right: 100px;"><img
    ...
    ">
      ...
      <div class="collapse navbar-collapse" id="navbarContent">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="navbar-item"><a href="#" class="nav-link">CVs</a></li>
          <li class="navbar-item"><a href="#" class="nav-link">Login</a></li>
          <li class="navbar-item"><a href="#" class="nav-link">Register</a></li>
        </ul>
      </div>
    </div>
  </nav>
