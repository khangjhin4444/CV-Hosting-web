            ...
            <?php } else { ?>
              <?php foreach ($users as $user) { ?>
                <tr>
                  ...
                  <td>
                    <form action="/CV-Hosting-web-main/app/controllers/CVController.php?action=createCV'" method="post"
    ...
    <div class="section" id="system-settings">
      ...
      <form action="/CV-Hosting-web-main/app/controllers/SettingsController.php" method="post">
        ...
        <div class="mb-3">
          ...
          <input type="number" id="cv-limit" name="cv_limit" value="<?php echo htmlspecialchars($cv_limit); ?>" min="1"
